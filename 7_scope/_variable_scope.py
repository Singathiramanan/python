...
def func():
    return a + 1  # Prints message at global scope 11

def func():
    # the value for b is assigned inside the function
    b = 20  # Local Variable
    # the value for a is assigned outside the function
    return a + b   # a refers to value 10 which is Global variable 30
...
def func():
    ...
    result = a + b  # Exception! (a will not refer to Global value 10) 30
    a = 20
    b = 30
    result = a + b #50
    return result #50
