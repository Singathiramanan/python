...
# "spam" executes or calls the function that is being passed to it.
# it is "spam"'s responsibility to call the function with correct signature
def spam(func, *args, **kwargs):
    result = func(*args, **kwargs)
    return result

# In the below function, wrapper is the one which calls "func". "spam" returns the reference 
