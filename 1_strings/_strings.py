...
# rounding off to "N" digits after decimal
total_cost = 345.20915
print(f"{total_cost:.2f}") # rounds off to 2 integers after decimal 

# Zero Padding
print(f"{2:03}")  # Adds 3 trailing zeros
